            ...
            <div className='test1'>
                ...
                <div id='about-outer'>
                    ...
                    <div id='about-id'>
                        ...
                        <motion.p className='mobilep' whileInView={{ opacity: 1 }} initial={{ opacity: 0 }} transition={{ duration: 0.3, delay: 0.6 }}>I'm a passionate web developer with a love for crafting elegant and functional digital experiences.
